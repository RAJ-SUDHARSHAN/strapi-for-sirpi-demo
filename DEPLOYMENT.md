...
Infrastructure generated by [Sirpi](https://sirpi.dev) for your **strapi** application.
...
2. Verify your app responds on port 1337
3. Test health check endpoint locally: `curl http://localhost:1337/`
...
- Security groups restrict traffic (ALB → ECS on port 1337 only)
...
<sub>Generated by Sirpi • Session: sess_fc962d732d90 • [View Original Generation](https://sirpi.dev/generation/sess_fc962d732d90)</sub>
